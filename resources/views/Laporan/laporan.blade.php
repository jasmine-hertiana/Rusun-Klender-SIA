...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Laporan Pembayaran Biaya Rumah Tangga</div>
                <div class="card-body"> 
                <form action="/laporan/laporan" method="PUT" target="_blank"> 
                    @csrf
                    <fieldset>
                    <div class="form-group row"> 
                        <div class="col-md-4">
                            <label for="klasifikasi">Periode Transaksi</label>
                            <input id="jenis" type="hidden" name="jenis" value="laporan" class="form-control">
