...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Rekapitulasi Pembayaran Gas Harian</div>
                <div class="card-body"> 
                <form action="/rekapgas/gas" method="PUT" target="_blank"> 
                    @csrf
                    <fieldset>
            ...
            <div class="card">
                <div class="card-header">Rekapitulasi Pembayaran Gas Mingguan</div>
                <div class="card-body"> 
                <form action="/rekapgas/gas" method="PUT" target="_blank"> 
                    @csrf
                    <fieldset>
            ...
            <div class="card">
                <div class="card-header">Rekapitulasi Pembayaran Gas Bulanan</div>
                <div class="card-body"> 
                <form action="/rekapgas/gas" method="PUT" target="_blank"> 
                    @csrf
                    <fieldset>
