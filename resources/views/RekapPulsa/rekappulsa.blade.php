...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Rekapitulasi Pembayaran Pulsa Harian</div>
                <div class="card-body"> 
                <form action="/rekappulsa/pulsa" method="PUT" target="_blank"> 
                    @csrf
                    <fieldset>
            ...
            <div class="card">
                <div class="card-header">Rekapitulasi Pembayaran Pulsa Mingguan</div>
                <div class="card-body"> 
                <form action="/rekappulsa/pulsa" method="PUT" target="_blank"> 
                    @csrf
                    <fieldset>
            ...
            <div class="card">
                <div class="card-header">Rekapitulasi Pembayaran Pulsa Bulanan</div>
                <div class="card-body"> 
                <form action="/rekappulsa/pulsa" method="PUT" target="_blank"> 
                    @csrf
                    <fieldset>
