...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Rekapitulasi Pembayaran Listrik Harian</div>
                <div class="card-body"> 
                <form action="/rekaplistrik/listrik" method="PUT" target="_blank"> 
                    @csrf
                    <fieldset>
            ...
            <div class="card">
                <div class="card-header">Rekapitulasi Pembayaran Listrik Mingguan</div>
                <div class="card-body"> 
                <form action="/rekaplistrik/listrik" method="PUT" target="_blank"> 
                    @csrf
                    <fieldset>
            ...
            <div class="card">
                <div class="card-header">Rekapitulasi Pembayaran Listrik Bulanan</div>
                <div class="card-body"> 
                <form action="/rekaplistrik/listrik" method="PUT" target="_blank"> 
                    @csrf
                    <fieldset>
